package product.example.apiproduct.database;
...
//    ));
    ...
    public static List<Product> getProductByFile() {
        String csvFile = "static/product.csv";
...
//            }
    ...
    public static void saveProductToFile() throws IOException {
        try {
            FileWriter fileWriter = new FileWriter("src/main/resources/static/product.csv");
