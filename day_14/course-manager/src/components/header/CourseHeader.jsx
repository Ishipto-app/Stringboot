            ...
            <div className="container">
                <div className="d-flex justify-content-start align-items-center">
                    ...
                    <div className="w-100 d-flex justify-content-between align-items-center">
                        <div className="menu">
                            <Link className="text-white text-uppercase ms-5" to="/khoa-hoc/phong-lab">Phòng lab</Link>
                            <Link className="text-white text-uppercase ms-3" to="/khoa-hoc/truc-tuyen">Trực tuyến</Link>
                        </div>
                        <div className="cart">
